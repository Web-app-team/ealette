...
const merge_extradata_1 = __importDefault(
  require('./merge-extradata')
);
const isAndroidRTL =
...
class AppIntroSlider extends React.Component {
  constructor() {
    ...
    this._renderOuterButton = (content, name, onPress) => {
      ...
      return (
        <react_native_1.View
          style={!this.props.bottomButton && style}
        >
    ...
    this._onMomentumScrollEnd = (e) => {
      ...
      this.props.onSlideChange &&
        this.props.onSlideChange(newIndex, lastIndex);
    };
    this._onLayout = ({ nativeEvent }) => {
      ...
      if (
        ...
        const func = () => {
          this.flatList?.scrollToOffset({
            offset:
              this._rtlSafeIndex(this.state.activeIndex) * width,
            animated: false,
          });
        };
  ...
  render() {
    ...
    const extra = merge_extradata_1.default(
      extraData,
      this.state.width
    );
    return (
