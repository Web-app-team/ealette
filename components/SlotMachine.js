...
export default class SlotMachine extends Component {
  ...
  constructor(props) {
    ...
    this.startInitialAnimation =
      this.startInitialAnimation.bind(this);
  ...
  getInitialSlotsValues(props) {
    ...
    const animationValue = this.getPosition(
      props.range.length - 1,
      props
    );
  ...
  renderContent(currentChar, i, range) {
    ...
    return (
      <Text style={[styles.text, overrideStyles.text]}>
        {textContent}
      </Text>
    );
  }
  ...
  renderSlot(charToShow, position) {
    ...
    return (
      ...
      >
        {slots}
        <View
          style={[styles.innerBorder, overrideStyles.innerBorder]}
        />
        <View
          style={[styles.outerBorder, overrideStyles.outerBorder]}
        />
        <View
          style={[
            styles.overlay,
